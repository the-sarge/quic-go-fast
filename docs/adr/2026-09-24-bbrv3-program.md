...
**Status:** Accepted; not dispatched
...
| --- | --- | --- | --- | --- |
| T: Transport feedback and send ownership | [Transport feedback and send ownership](2026-09-24-bbrv3-transport-plan.md) | pending | 5 | Not dispatched |
| B: Complete opt-in BBRv3 sender | [Complete opt-in BBRv3 sender](2026-09-24-bbrv3-controller-plan.md) | pending | 6 | Not dispatched |
| Q: Qualification readiness and evidence | [Qualification readiness and evidence](2026-09-24-bbrv3-qualification-plan.md) | pending | 2 | Not dispatched |

Initial frontier: **T1, T3 and Q1**. T1 and T3 own different primary seams (recovery dispatch versus emission/queue); Q1 inspects readiness without changing controller code. Use dedicated worktrees and reconcile shared interface touches before merge. Logical parallelism does not authorize simultaneous edits in one worktree. No whole-track sequential ordering is implied.
