...
| --- | --- | --- | --- | --- | --- |
| E — Packet emission | [Plan](2026-09-07-packet-emission-plan.md) | [#24](https://github.com/the-sarge/quic-go-fast/issues/24) | E1–E6, one intended PR each | E3 requires the accepted adoption decision and completed E2; E4 and E5 require E3; E6 requires E4 and E5 | E1 complete, uncertainty accepted; E2 complete; E3 retained for bounded diagnosis |

E1's [four-core evidence](../audits/e1-emission-four-core/README.md) remains inconclusive. The owner has [authorized staged adoption with that uncertainty accepted](../audits/2026-09-07-emission-adoption-decision.md); this satisfies the E1 migration prerequisite without changing the measurements or authorizing another feasibility campaign. E2's queue lifetime corrections are complete. E3 retains [PR #41](https://github.com/the-sarge/quic-go-fast/pull/41) and is ready only for the plan’s bounded certification diagnosis; its failed local certification is not waived. E4/E5 require E3 and E6 requires E4/E5. Shared-file merges remain serialized and revalidated without invented dependencies.

Performance qualification uses the plan's four-core deployment domain; two-core results remain diagnostic only. The current frontier is E3’s bounded diagnostic continuation; its runtime remains unmerged. The [scoped audit](../audits/2026-09-07-e3-certification-handoff.md) records the retained evidence and strict-certification decision. Later slices retain their correctness and bounded performance gates. Parent issues are never implementation tasks, and the tracking issue owns the live mapping.
