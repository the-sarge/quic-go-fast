...
The owner has authorized staged adoption with the recorded E1 timing and host-isolation uncertainty accepted. E1 evidence remains inconclusive and unchanged; the decision satisfies its migration prerequisite without authorizing another feasibility campaign. Later slices retain their bounded correctness and performance gates. See the [adoption decision](https://github.com/the-sarge/quic-go-fast/blob/3db9121a2c91bce8acb7b6f871adfcaf51bc560b/docs/audits/2026-09-07-emission-adoption-decision.md).
