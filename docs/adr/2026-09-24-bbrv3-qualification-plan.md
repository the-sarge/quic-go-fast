...
The operator extended Q1 preparation from eight to 16 cumulative hours on 2026-09-25 ([authorization](https://github.com/the-sarge/quic-go-fast/issues/598#issuecomment-5837538642)). The operator subsequently approved 56 total experiment-hours on the same date, retaining the $100 cloud ceiling and all usage. The [approved current forecast](../audits/2026-09-25-bbrv3-q1-campaign/budget-proposal.md) replaces the historical allocation. Mac endpoints may use otherwise-idle hosts with GOMAXPROCS=4, identical Reno/BBRv3 settings, separate gateway resources and recorded CPU contention; no four-isolated-physical-core claim is permitted for Mac results.
...
**Evidence budget:** The existing accepted campaign budget applies verbatim: Q1 has at most 16 cumulative preparation hours; the shared Q1/Q2 ledger permits at most 56 experiment-hours including failed runs, launch and teardown. The current forecast retains 8.718 hours already reserved, 36 core warm-up/measurement hours, two completion hours, 1.75 remaining calibration hours and six command-overhead hours, leaving 1.532 contingency hours. No additional cases are authorized here. Required safety validation cannot be demoted on budget exhaustion. One fresh review and at most one replacement. Terminate when the named evidence, scope-specific local gates and same-head hosted CI pass with no unresolved stop-for-decision.
...
**Blast radius:** 56 experiment-hour ceiling, five paired repetitions, native platform/offload/ECN distinctions, host contention, control latency and resource cost. No extra statistical/platform cross-product or unbudgeted sensitivity. No untraced effect is accepted; newly discovered effects outside this boundary invoke the stop conditions.
