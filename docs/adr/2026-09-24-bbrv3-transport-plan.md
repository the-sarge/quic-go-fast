...
| GSO/coalescing/MTU probe | Charge physical payload and bounded exception | emission admission | real-packer fixture | Covered by `TestBBRPendingCreditGSOFallback`, `TestBBRPendingCreditMTUException` |
