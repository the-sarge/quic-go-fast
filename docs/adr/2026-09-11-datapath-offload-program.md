...
**Identity:** QGF-DP-2026-09. **Status:** Accepted; tracks not yet implemented.
...
|---|---|---|---|---|---|---|
| G | Linux coalesced receive (GRO) | [G plan](2026-09-11-linux-gro-plan.md) | pending | None | G1, G2 | G1 FRONTIER |
| W | Windows datapath (foundation, USO, URO) | [W plan](2026-09-11-windows-datapath-plan.md) | pending | W3 requires G1 | W1, W2, W3 | W1 FRONTIER |
| D | Darwin batch send + receive experiment | [D plan](2026-09-11-darwin-batch-plan.md) | pending | None | D1, D2 | D1 FRONTIER |

Cross-track slice edges: W3 requires G1 (coalesced-storage contract and split helper). In-track edges: G2 requires G1; W2 requires W1; W3 requires W1; D2 requires D1. The frontier is G1, W1, and D1, which touch disjoint files and are parallel-safe. Recommended starter: G1 (smallest, and it unblocks both G2 and W3). The program's evidence-per-effort ordering recommends completing G and W adoption before D by preference; that recommendation is not a blocking edge. Seven intended PRs, seven fresh implementation contexts.
