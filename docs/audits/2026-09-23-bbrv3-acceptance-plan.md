...
**Current budget amendment, 2026-09-26:** The operator's later instruction to stop worrying about time and make it 72 applies to both cumulative preparation and the separate total experiment-hour ceiling. The active cloud cap remains $100; the operator pre-authorized $150 if needed, but that conditional increase has not been activated. Every prior reservation remains charged. The original allocation above is historical; the [current forecast](2026-09-25-bbrv3-q1-campaign/budget-proposal.md) accounts for 69.984667 hours before contingency, including the eight-hour Mac window and bounded review corrections, leaving 2.015333 hours. The accepted case inventory is unchanged.
