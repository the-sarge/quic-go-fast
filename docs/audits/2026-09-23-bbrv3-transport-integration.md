...
| RTT/MTU | ACK-delay eligibility, restored latest/smoothed estimates without a measured minimum, migration measurement reset, cross-space RTT filtering, expiring BBR minima, MTU growth and handshake fallback. Recovery timers preserved and explicit controller RTT/size policy. |
