...
previous=json.loads((root/'build-receipt.json').read_text())
receipt['steps']=previous['steps']
receipt['initial_builder_sha256']=previous['builder_sha256']
receipt['disposition']='Baseline full suite hit pre-existing TestMITCorruptPackets/towards_the_client one-second Dial deadline; preserved failure, no rerun. Continue remaining independent checks and candidate validation.'
...
for variant,head in [('base','e742e3ee64c79c61440061a86f56e2e223a776ef'),('candidate','8e61c8e8b9997204316d6009b9065943a5e8b82f')]:
 ...
 for label,cmd in commands:
  if any(x['variant']==variant and x['kind']==label for x in receipt['steps']):continue
