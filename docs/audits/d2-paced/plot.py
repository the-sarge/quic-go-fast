...
fig.text(0.04, 0.03, "Points: paired estimates; bars: bootstrap 95% intervals. Lower favors head-index.\n* At least one sample missed 98% of its requested rate; interpret at achieved rates.\nSynthetic queue workload, not a network transfer. Intermittent VM activity weakens timing attribution.", fontsize=9, color="#555555")
fig.tight_layout(rect=(0.03, 0.13, 1, 0.89), w_pad=2)
